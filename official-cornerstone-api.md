...
copy_to | (optional) **String** A comma-separated list of email addresses to carbon copy the merchant receipts to. Note: this only works if merchant receipts are enabled in your settings.
