...
<pre><code><input type=hidden name=callback value="https://example.com/return_transaction?token=438271">
<input type=hidden name=callback_field[id] value=trans_id>
